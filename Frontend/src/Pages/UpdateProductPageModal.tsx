...
function UpdateProductPageModal({ product, setProduct, setIsEdit }: Props) {
    ...
    return (
        <>
            {/* Main modal */}
            <div id="crud-modal" tabIndex={-1} aria-hidden="true" className="fixed inset-0 z-50 flex justify-center items-center w-full p-4 overflow-x-hidden overflow-y-auto h-[calc(100%-1rem)] max-h-full">
                <div className="relative p-4 w-full max-w-md max-h-full">
                    {/* Background Overlay */}
                    <div className="fixed inset-0 bg-black bg-opacity-50"></div>

                    <div className="relative w-full max-w-md max-h-full z-10"></div>
                    {/* Modal content */}
